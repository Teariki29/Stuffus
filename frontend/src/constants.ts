...
export const DIM_META: Record<string, { icon: string; color?: string }> = {
  ...
  prospection: { icon: "magnifier", color: "var(--accent)" },
  ...
  force: { icon: "fist", color: EL.terre },
  intelligence: { icon: "flame", color: EL.feu },
  chance: { icon: "clover", color: EL.eau },
  agilite: { icon: "wing", color: EL.air },
  puissance: { icon: "bolt", color: "var(--accent)" },
  do_fixe: { icon: "burst", color: "#c9ccd4" },
  do_terre: { icon: "gem", color: EL.terre },
  do_feu: { icon: "flame", color: EL.feu },
  do_eau: { icon: "waterdrop", color: EL.eau },
  do_air: { icon: "wing", color: EL.air },
  do_neutre: { icon: "star", color: EL.neutre },
